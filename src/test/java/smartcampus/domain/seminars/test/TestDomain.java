...
import eu.trentorise.smartcampus.domain.parchimetri.ParchimetriServiceDOEngine;
...
public class TestDomain {
	...
	private static void initDomain(DomainTestHelper helper) {
		helper.start(
				  ...
				  new ParchimetriServiceDOEngine()
				  );
	}
	...
	private static void poisCreation(HornetQJMSConnectionFactory cf,
		...
		ServiceBusAdminClient admin = new JMSServiceBusAdminClient(cf);
		  admin.restartService("smartcampus.service.Parchimetri", "GetParchimetri");
		  System.err.println();
	}
}
